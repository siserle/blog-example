        ...
        function page:site-content-if-blog-db-exists()
{
  ...
  (:let $postings := for $posting in $db/blog/postings/posting
                   let $r := <p><small>On {fn:substring(string($posting/@postingdate), 0, 11) || " at " || 
                               ...
                               <a href="blog-v1/change-posting/{string($posting/@postingdate)}">change</a> | 
                               <a href="blog-v1/add-comment/{string($posting/@postingdate)}">add comment</a> | 
                               <a href="blog-v1/show-comments/{string($posting/@postingdate)}">
