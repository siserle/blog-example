        ...
        function page:site-content-if-blog-db-exists()
{
  ...
  let $postings := for $posting in $db/blog/postings/posting
                   let $r := <p><small>On {fn:substring(string($posting/@postingdate), 0, 11) || " at " || 
                               ...
                               <a href="blog-v1/delete-posting/{string($posting/@postingdate)}">delete</a> | 
                               <a href="blog-v1/change-posting/{string($posting/@postingdate)}">change</a></p>
                   return $r
  ...
  return
   <html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
      ...
      <p><form method="post" action="blog-v1/new-posting">
        <p>Add new posting:</p>
        <table>
          <tr>
...
(:~
 ...
 :)
declare %restxq:path("blog-v1/drop-database")
        %restxq:GET
...
(:~
 ...
 :)
declare %restxq:path("blog-v1/show-blog-xml")
...
(:~
 ...
 :)
declare %restxq:path("blog-v1/new-posting")
        %restxq:POST
...
(:~
 ...
 :)
declare %restxq:path("blog-v1/delete-posting/{$id}")
        %restxq:GET
...
(:~
 ...
 :)
declare %restxq:path("blog-v1/change-posting/{$id}")
        %output:method("xhtml")
        %output:omit-xml-declaration("no")
        %output:doctype-public("-//W3C//DTD XHTML 1.0 Transitional//EN")
        %output:doctype-system("http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd")
  ...
  return 
   <html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
      ...
      <p class='right'><a href='/restxq/blog-v1'>...back to main page</a></p>
    </body>
  </html>
};
...
(:~
 ...
 :)
declare %restxq:path("blog-v1/change-posting/replace-posting/{$id}")
        %restxq:POST
        %restxq:form-param("new-postingtitle","{$postingtitle}", "''")
        %restxq:form-param("new-postingtext","{$postingtext}", "''")
